...
void CompassOverlay::RenderOverlay() {
    Agent curAg, agSelf;
    Character curChar;
    Vector3 camVec, agPos, agSelfPos;
    Compass comp;
...
bool CompassOverlay::FilterDot(Agent ag) {
...
int CompassOverlay::CalcFade(Vector3 self, Vector3 ag) {
    int alpha = alphaMask;
    if (compDotsFade) {
        float fr = fadeMark;
...
int CompassOverlay::GetColor(Character curChar, int initialColor = 0xFF000000) {
